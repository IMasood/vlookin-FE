    ...
    <>
      <div>
        ...
        <div className="mb_form_heading">
          <h2>
            Notify Users <FaBell style={{ color: "#4A0D37" }} />{" "}
          </h2>
        </div>
      </div>
      <div className="body">
        <Row>
          ...
          <Col offset={isMobile ? 0 : 4} md={10} sm={16}>
            <div style={{ marginTop: isMobile ? "15px" : "52px" }}>
              {role == "superadmin" ? (
                <RealEstateDropDown
                  setSelectedRealEstate={setSelectedBuilding}
                />
              ) : (
        ...
        <div className="addform_btn">
          <CustomButton
            ...
            buttonName={<FaBell style={{ color: "white" }} />}
            bgColor={redColor}
            color={"#F8F8F8"}
            loading={showLoader}
            disabled={showLoader}
