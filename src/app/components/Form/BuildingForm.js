...
import { addBuildingInitialValues } from "../../utils/schemas/addBuilding/initalValues";
import { addBuildingSchemas } from "../../utils/schemas/addBuilding/addBuildingSchemas";
import AddBuildingService from "../../utils/services/addBuilding/addBuilding.service";
...
const BuildingForm = ({ showDrawer }) => {
  ...
  const {
    ...
    initialValues: addBuildingInitialValues,
    validationSchema: addBuildingSchemas,
    onSubmit: async (values) => {
      try {
        ...
        let response = await AddBuildingService.addBuilding(values);
        if (response.data.status === 200) {
          setShowLoader(false);
          toast.success("Building Created Successfully");
          navigate(routePaths.Admin.addAppartment);
      ...
      <div className="body">
        ...
        <div className="addform_btn">
          ...
          <AddRealEstateModal
            open={open}
            onCancel={onCancel}
            setRealEstateAdded={setRealEstateAdded}
          />
          <CustomAlert />
        </div>
      </div>
