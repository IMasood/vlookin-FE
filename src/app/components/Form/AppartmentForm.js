...
const AppartmentForm = ({ title, showDrawer }) => {
  ...
  const addApartment = async () => {
    try {
      ...
      const apartmentNamesArray = inputs.apartmentName
        .split(",")
        .map((name) => name.trim());
      let data = {
      ...
      <div className="body">
        <Row>
          ...
          <Col offset={isMobile ? 0 : 4} md={10} sm={18}>
            <Form>
              <div>
                ...
                <Input
                  ...
                  className="apartment_form_input my-3"
                  name="area"
                  size="large"
                  value={inputs.area}
              ...
              <p className="form_label mb-1">Furnished</p>
              <Form.Item
                name="radio-button"
                className="form_radio_inputs"
                rules={[
              ...
              >
                ...
                <Radio.Group onChange={handleRadioChange}>
                  ...
                  <Radio.Button className="radio_btn" value="Full-Furnished">
                    Full-Furnished
                  </Radio.Button>
                </Radio.Group>
              </Form.Item>
              <p className="form_label mb-1">Balcony</p>
              <Form.Item
                name="radio-button"
                className="form_radio_inputs"
                rules={[
              ...
              <div>
                <label className="required-field pb-3">Rent</label>
                <Input
              ...
              {/* <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please enter rent of an apartment",
                  },
                ]}
              >
                <Input
            ...
            <div className="pt-3">
              <label className="required-field pb-3">Comment</label>
              <TextArea
                rows={4}
                className="apartment_form_input"
